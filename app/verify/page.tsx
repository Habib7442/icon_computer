    ...
    <div className="bg-white dark:bg-slate-950 text-slate-900 dark:text-white font-sans min-h-screen">
      <section className="relative py-20 bg-linear-to-b from-slate-50 dark:from-slate-900 to-indigo-950/20 border-b border-white/5 overflow-hidden">
        ...
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 text-center">
          <Badge className="bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 px-3 py-1 mb-3">Verification</Badge>
          <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl text-slate-900 dark:text-slate-100 font-outfit">
            Student <span className="text-emerald-400">Verification</span>
          </h1>
          <p className="mt-4 text-slate-600 dark:text-slate-400 text-base max-w-md mx-auto leading-snug">
            Instantly verify student enrollment or course completion certificates securely here dashboards.
          </p>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto max-w-md px-4 sm:px-6">
          <div className="bg-white dark:bg-slate-900/40 border border-slate-200 dark:border-slate-800/80 backdrop-blur-md rounded-2xl p-6 shadow-2xl relative overflow-hidden">
            ...
            <h2 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2">Search Enrollment</h2>
            <p className="text-xs text-slate-600 dark:text-slate-400 mb-4">Enter Registration No / Student ID to fetch authentic records option dashboards dashboards.</p>
            
            <div className="space-y-4">
              <div className="relative">
                <Input placeholder="E.g. ICI/1024/2026" className="bg-white dark:bg-slate-950 border-slate-200 dark:border-slate-800 text-slate-900 dark:text-slate-100 pl-4 h-11 rounded-xl focus-visible:ring-emerald-500/50" />
              </div>
